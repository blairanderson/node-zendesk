...
Views.prototype.tickets = function (viewID, numberRecords, cb) {
  if (arguments.length === 3) {
    // Important - Zendesk return here is a little stragely formatted, so you need to specify the number
    // pages to import (100 records / page).  Not ideal, but based on their unusual return format for this request
    // maxRecords = Math.ceil(maxRecords/100);
